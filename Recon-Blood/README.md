...
| RBC | 0.77 | 0.78 | 0.78 | +14.1% |
| Platelet | 0.73 | 0.73 | 0.70 | −4.1% |
| **micro** | **0.78** | **0.79** | **0.79** | — |

WBC 在 IoU 0.3 下 F1 達 ~0.93（精確率 0.92–0.96），RBC 召回率 ~0.84、F1 ~0.78，三類細胞計數誤差皆在 **±30%** 內，且 test/val/全資料集一致（未過擬合）。完整優化歷程見 [`report.md`](report.md)。
