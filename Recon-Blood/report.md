...
| Platelet 誤差 ±30% | 184 / 364 | 50.5% | 46.1% |
| 三類同時 ±30% | 103 / 364 | 28.3% | — |

此版本捨棄只針對前 5 張表現最佳的 RBC 參數，改採較保守的過度偵測防護，目標是讓未知驗收圖片有更高機會落在 ±30% 內。實測上，三類同時通過比例由前一版的 59 / 364（16.2%）提升到 103 / 364（28.3%）。
